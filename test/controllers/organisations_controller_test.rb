...
class OrganisationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create organisation" do
    assert_difference('Organisation.count') do
      post organisations_url, params: { organisation: { address: @organisation.address, email: @organisation.email, logo_url: @organisation.logo_url, name: @organisation.name, phone: @organisation.phone, website: @organisation.website } }
    end
  ...
  test "should update organisation" do
    patch organisation_url(@organisation), params: { organisation: { address: @organisation.address, email: @organisation.email, logo_url: @organisation.logo_url, name: @organisation.name, phone: @organisation.phone, website: @organisation.website } }
